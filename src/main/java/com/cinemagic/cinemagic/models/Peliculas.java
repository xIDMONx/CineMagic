...
public class Peliculas {
    ...
    public @NotBlank(message = "Titulo es requerido") String getTitulo() {
        return titulo;
    }

    public void setTitulo(@NotBlank(message = "Titulo es requerido") String titulo) {
        this.titulo = titulo;
    }
    ...
    public @NotBlank(message = "Genero es requerido") String getGenero() {
        return genero;
    }

    public void setGenero(@NotBlank(message = "Genero es requerido") String genero) {
        this.genero = genero;
    }
